...
they went, so the two can be brought together either way.

They are worth reading before the task pages themselves, because several of
them explain why a task page says something the landing page does not.
